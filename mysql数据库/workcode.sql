...
Source Database       : workcode

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2020-11-11 14:56:30
*/
...
CREATE TABLE `ylrc_clazz` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKjk9yuss1wc94mss6oe64s5lpt` (`teacher_id`),
  CONSTRAINT `FKjk9yuss1wc94mss6oe64s5lpt` FOREIGN KEY (`teacher_id`) REFERENCES `ylrc_teacher` (`id`)
...
CREATE TABLE `ylrc_clbum` (
  ...
  `create_time` datetime NOT NULL,
  `update_time` datetime NOT NULL,
  `clbname` varchar(255) DEFAULT NULL,
  `college` varchar(255) DEFAULT NULL,
  `major` varchar(255) DEFAULT NULL,
  `teacher_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKqigex7fagj8yu3lunguikh7ar` (`teacher_id`),
  CONSTRAINT `FKqigex7fagj8yu3lunguikh7ar` FOREIGN KEY (`teacher_id`) REFERENCES `ylrc_teacher` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ylrc_clbum
-- ----------------------------
...
CREATE TABLE `ylrc_log_integral` (
  ...
  `bonus_points` varchar(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKc4gr3r9cgmy30j4ul0rj3arc1` (`student_id`),
  CONSTRAINT `FKc4gr3r9cgmy30j4ul0rj3arc1` FOREIGN KEY (`student_id`) REFERENCES `ylrc_student` (`id`)
...
INSERT INTO `ylrc_menu` VALUES ('39', '2020-10-31 16:10:16', '2020-11-03 10:00:22', '教师列表', '/tea/list', 'mdi-account-multiple', '0', '48', '', '');
INSERT INTO `ylrc_menu` VALUES ('46', '2020-11-02 09:18:29', '2020-11-02 09:18:29', '学生管理', '', 'mdi-clipboard-account', '0', null, '', '');
INSERT INTO `ylrc_menu` VALUES ('47', '2020-11-02 09:19:05', '2020-11-02 09:19:05', '学生列表', '/stu/list', 'mdi-alarm-multiple', '0', '46', '', '');
INSERT INTO `ylrc_menu` VALUES ('48', '2020-11-02 09:25:03', '2020-11-02 09:57:53', '教师管理', '', 'mdi-arrow-left-bold-box', '0', null, '', '');
INSERT INTO `ylrc_menu` VALUES ('49', '2020-11-02 09:51:12', '2020-11-02 09:51:12', '阅览室管理', '', 'mdi-book-open-variant', '0', null, '', '');
INSERT INTO `ylrc_menu` VALUES ('50', '2020-11-02 09:54:19', '2020-11-02 09:54:19', '座位管理', '/seat/list', 'mdi-human-child', '0', '49', '', '');
INSERT INTO `ylrc_menu` VALUES ('51', '2020-11-02 09:59:33', '2020-11-02 09:59:33', '增加', '/stu/add', 'mdi-account-multiple-plus', '0', '47', '', '');
INSERT INTO `ylrc_menu` VALUES ('52', '2020-11-02 10:00:03', '2020-11-02 10:00:03', '删除', 'del(\'/stu/delete\')', 'mdi-account-multiple-minus', '0', '47', '', '');
INSERT INTO `ylrc_menu` VALUES ('53', '2020-11-02 10:00:36', '2020-11-02 10:00:36', '修改', 'edit(\'/stu/edit\')', 'mdi-account-card-details', '0', '47', '', '');
INSERT INTO `ylrc_menu` VALUES ('54', '2020-11-02 10:11:50', '2020-11-02 10:11:50', '增加', '/tea/add', 'mdi-account-multiple-plus', '0', '39', '', '');
INSERT INTO `ylrc_menu` VALUES ('55', '2020-11-02 10:12:33', '2020-11-02 10:12:33', '删除', 'del(\'/tea/delete\')', 'mdi-account-multiple-minus', '0', '39', '', '');
INSERT INTO `ylrc_menu` VALUES ('56', '2020-11-02 10:13:02', '2020-11-02 10:13:02', '修改', 'edit(\'/tea/edit\')', 'mdi-account-network', '0', '39', '', '');
INSERT INTO `ylrc_menu` VALUES ('59', '2020-11-02 12:11:08', '2020-11-02 12:11:08', '阅览室类型', '/readType/list', 'mdi-view-sequential', '0', '49', '', '');
INSERT INTO `ylrc_menu` VALUES ('60', '2020-11-02 12:35:01', '2020-11-02 12:35:01', '生成座位', 'add(\'/seat/add\')', 'mdi-wheelchair-accessibility', '0', '50', '', '');
INSERT INTO `ylrc_menu` VALUES ('61', '2020-11-02 13:05:47', '2020-11-02 13:05:47', '新增', '/readType/add', 'mdi-tooltip-outline-plus', '0', '59', '', '');
INSERT INTO `ylrc_menu` VALUES ('62', '2020-11-02 13:13:28', '2020-11-02 13:13:50', '删除', 'del(\'/readType/delete\')', 'mdi-backspace', '0', '59', '', '');
INSERT INTO `ylrc_menu` VALUES ('63', '2020-11-02 13:47:27', '2020-11-02 14:30:02', '编辑', 'edit(\'/readType/edit\')', 'mdi-pencil-box', '0', '59', '', '');
INSERT INTO `ylrc_menu` VALUES ('64', '2020-11-02 13:51:51', '2020-11-02 13:52:07', '信用积分管理', '', 'mdi-account', '0', null, '', '');
INSERT INTO `ylrc_menu` VALUES ('65', '2020-11-02 13:52:55', '2020-11-02 13:52:55', '信用积分', '/log/list', 'mdi-android-debug-bridge', '0', '64', '', '');
INSERT INTO `ylrc_menu` VALUES ('66', '2020-11-02 13:56:15', '2020-11-02 14:56:11', '选座', 'choose( \'/seat/choose\')', 'mdi-seat-legroom-reduced', '0', '50', '', '');
INSERT INTO `ylrc_menu` VALUES ('69', '2020-11-02 14:54:22', '2020-11-02 14:54:22', '阅览室', '/readRoom/list', 'mdi-apps', '0', '49', '', '');
INSERT INTO `ylrc_menu` VALUES ('72', '2020-11-02 15:11:28', '2020-11-02 15:11:38', '删除', 'del(\'/readRoom/delete\')', 'mdi-close-octagon', '0', '69', '', '');
INSERT INTO `ylrc_menu` VALUES ('75', '2020-11-02 15:21:20', '2020-11-02 15:21:20', '新增', '/readRoom/add', 'mdi-account-plus', '0', '69', '', '');
INSERT INTO `ylrc_menu` VALUES ('76', '2020-11-02 15:22:26', '2020-11-02 15:22:26', '班级管理', '', 'mdi-account-multiple', '0', null, '', '');
INSERT INTO `ylrc_menu` VALUES ('81', '2020-11-02 15:32:09', '2020-11-02 15:32:09', '班级列表', '/clbum/list', 'mdi-alarm-plus', '0', '76', '', '');
INSERT INTO `ylrc_menu` VALUES ('82', '2020-11-02 15:33:02', '2020-11-02 15:33:02', '编辑', 'edit(\'/readRoom/edit\')', 'mdi-cursor-pointer', '0', '69', '', '');
INSERT INTO `ylrc_menu` VALUES ('87', '2020-11-02 15:54:07', '2020-11-02 16:06:10', '添加', '/clbum/add', 'mdi-arrow-up-thick', '58', '81', '', '');
INSERT INTO `ylrc_menu` VALUES ('89', '2020-11-02 18:28:39', '2020-11-02 18:28:39', '编辑', 'edit(\'/clbum/edit\')', 'mdi-border-color', '0', '81', '', '');
INSERT INTO `ylrc_menu` VALUES ('90', '2020-11-02 18:29:52', '2020-11-02 18:29:52', '删除', 'del(\'/clbum/delete\')', 'mdi-account-multiple', '0', '81', '', '');
INSERT INTO `ylrc_menu` VALUES ('91', '2020-11-03 09:13:09', '2020-11-03 09:13:09', '违规统计', '/statistics/violate', 'mdi-airplane-takeoff', '0', '2', '', '');
INSERT INTO `ylrc_menu` VALUES ('92', '2020-11-03 09:20:46', '2020-11-03 09:20:46', '占座统计', '/statistic/occupied', 'mdi-arrow-down-bold-box', '0', '2', '', '');
INSERT INTO `ylrc_menu` VALUES ('93', '2020-11-04 10:36:50', '2020-11-04 10:39:41', '学生座位预约记录', '/seat/stu/order', 'mdi-baby', '0', '49', '', '');
INSERT INTO `ylrc_menu` VALUES ('94', '2020-11-04 12:10:36', '2020-11-04 12:10:36', '取消预约', 'del(\'/seat/delete\')', 'mdi-window-close', '0', '93', '', '');
INSERT INTO `ylrc_menu` VALUES ('95', '2020-11-04 14:26:19', '2020-11-04 14:27:07', '查看', '“”', 'mdi-account-multiple-outline', '0', '69', '', '');
INSERT INTO `ylrc_menu` VALUES ('96', '2020-11-04 14:34:03', '2020-11-04 14:34:55', '我的信用积分', '/log/stuList', 'mdi-android', '0', '64', '', '');
INSERT INTO `ylrc_menu` VALUES ('98', '2020-11-04 15:35:14', '2020-11-04 15:50:12', '上传图片', '/upload/upload_photo', 'mdi-account-plus', '0', '96', '', '');
INSERT INTO `ylrc_menu` VALUES ('99', '2020-11-04 16:38:05', '2020-11-04 17:34:30', '座位状态管理', 'able( \'/seat/able\')', 'mdi-account-settings-variant', '0', '50', '', '');
...
CREATE TABLE `ylrc_reading` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKtb538iuk3363um3ci0v27stiu` (`readingtype_id`),
  CONSTRAINT `FKtb538iuk3363um3ci0v27stiu` FOREIGN KEY (`readingtype_id`) REFERENCES `ylrc_reading_type` (`id`)
...
CREATE TABLE `ylrc_seat` (
  ...
  `reading_room_id` bigint(20) DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK6ihx1ae0jjtb7ti743s5xg1jm` (`reading_room_id`),
  CONSTRAINT `FK6ihx1ae0jjtb7ti743s5xg1jm` FOREIGN KEY (`reading_room_id`) REFERENCES `ylrc_reading` (`id`)
...
CREATE TABLE `ylrc_seat_order` (
  ...
  `student_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKsqounhge0sthl3ntomo1kioaf` (`reading_room_id`),
  KEY `FKenqfmk2lg9jubigogddmqitkk` (`seat_id`),
  KEY `FK969ixexxv516s5s75dj8ha7xo` (`student_id`),
  CONSTRAINT `FK969ixexxv516s5s75dj8ha7xo` FOREIGN KEY (`student_id`) REFERENCES `ylrc_student` (`id`),
  CONSTRAINT `FKenqfmk2lg9jubigogddmqitkk` FOREIGN KEY (`seat_id`) REFERENCES `ylrc_seat` (`id`),
  CONSTRAINT `FKsqounhge0sthl3ntomo1kioaf` FOREIGN KEY (`reading_room_id`) REFERENCES `ylrc_reading` (`id`)
...
CREATE TABLE `ylrc_student` (
  ...
  `clbum_id` bigint(20) DEFAULT NULL,
  `user_id` bigint(20) DEFAULT NULL,
  `clazz_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK89cfymtntl7r27cl2ob87or47` (`clbum_id`),
  KEY `FKfkb8i6ywm8vgcupxtb90xwc48` (`user_id`),
  KEY `FKsaiyoj6psj7297tjedfad0kx6` (`clazz_id`),
  CONSTRAINT `FKfkb8i6ywm8vgcupxtb90xwc48` FOREIGN KEY (`user_id`) REFERENCES `ylrc_user` (`id`),
  CONSTRAINT `FKsaiyoj6psj7297tjedfad0kx6` FOREIGN KEY (`clazz_id`) REFERENCES `ylrc_clazz` (`id`)
...
CREATE TABLE `ylrc_teacher` (
  ...
  `create_time` datetime NOT NULL,
  `update_time` datetime NOT NULL,
  `teacher_sno` varchar(255) DEFAULT NULL,
  `teacher_type_id` bigint(20) DEFAULT NULL,
  `user_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKnrp6f1yd0838a5lxdg4g99hin` (`teacher_type_id`),
  KEY `FKip1038wx983swfi24f6w2700m` (`user_id`),
  CONSTRAINT `FKip1038wx983swfi24f6w2700m` FOREIGN KEY (`user_id`) REFERENCES `ylrc_user` (`id`),
  CONSTRAINT `FKnrp6f1yd0838a5lxdg4g99hin` FOREIGN KEY (`teacher_type_id`) REFERENCES `ylrc_teacher_type` (`id`)
...
CREATE TABLE `ylrc_user` (
  ...
  KEY `FKo1aut9eqpf0b0o2fsf44tm4ai` (`student_id`),
  KEY `FKbxe3muf59w1na3xlchk6g9lel` (`teacher_id`),
  CONSTRAINT `FKbxe3muf59w1na3xlchk6g9lel` FOREIGN KEY (`teacher_id`) REFERENCES `ylrc_teacher` (`id`),
  CONSTRAINT `FKg09b8o67eu61st68rv6nk8npj` FOREIGN KEY (`role_id`) REFERENCES `ylrc_role` (`id`),
  CONSTRAINT `FKo1aut9eqpf0b0o2fsf44tm4ai` FOREIGN KEY (`student_id`) REFERENCES `ylrc_student` (`id`)
...
INSERT INTO `ylrc_user` VALUES ('25', '2020-10-31 16:39:48', '2020-11-05 10:20:35', '115432031@qq.com', '20201031/1604126733060.jpg', '15518166316', '12656', '2', '1', '263', '10', '小白', null, null);
